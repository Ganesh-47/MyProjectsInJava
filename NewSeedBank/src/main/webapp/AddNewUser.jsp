...
<tr><td>Address <span>*</span> </td><td><input type="text" name="useraddress" id="address" onkeyup="validateAddress()"  pattern="^[#.0-9a-zA-Z\s,-]+$"  title="Address in the format '1, North Street, Chennai - 11' " class="form-control" placeholder="Enter Address" required><p id="errorMessage2" style="color: red"></td></tr>
