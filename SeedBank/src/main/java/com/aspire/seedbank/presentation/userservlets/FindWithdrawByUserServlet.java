...
/**
 * Servlet implementation class FindWithdrawByUserServlet
 */
@WebServlet("/FindWithdrawByUserServlet")
public class FindWithdrawByUserServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * Default constructor. 
     */
    public FindWithdrawByUserServlet() {
