...
<div style="color:white;">Category Id: 		<input type="number" class="form-control" name="categoryid" id="categoryid" size="50" pattern="[0-9]{2,10}" title="Category Id should contains only numbers and length should be greater than 2 and not more than 10" required></div>
<div style="color:white;">Seed Name: 		<input type="text" class="form-control" name="seedname" id="seedname" size="50" pattern="^(?!.*([A-Za-z])\1{2})[A-Za-z]+$"  title="Seed Name should contains only Alphabates and shouldnot repeat 3 times and legth should be atleast 2 and not more than 20" required></div>
