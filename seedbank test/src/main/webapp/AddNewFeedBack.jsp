...
<table>
<tr><td>Order Id <span>*</span></td><td><input type="number" placeholder="Enter Here" class="form-control my-2" name="orderid" id="orderid" pattern="[0-9]{2,10}" title="Order Id should contains only numbers and length should be greater than 2 and not more than 10" size="50" required></td></tr>
