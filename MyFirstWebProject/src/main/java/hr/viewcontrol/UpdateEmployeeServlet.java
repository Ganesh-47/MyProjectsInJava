...
public class UpdateEmployeeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		response.setContentType("text/html");
		  ...
		  StringBuilder htmlbuilder=new StringBuilder(500);
		   //form begin
		   htmlbuilder.append("<form action='UpdateEmployeeServlet' method='post'>");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Employee emp =null;
		  ...
		  if(output>0)
		   outputwriter.write("<h2> Updated " +output+" </h2>");
		  else
		   outputwriter.write("<h2> Updation Failed </h2>");
	}catch(Exception e) {
		outputwriter.write("<h2> Updation Failed due to Invalid Inputs</h2>");
	}
