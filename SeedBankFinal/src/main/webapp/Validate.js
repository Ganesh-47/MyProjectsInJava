...
function validateId(){
	...
	if(patt.test(id)&&id<1000000000)
	{
			document.getElementById('errorMessage12').innerHTML="<p></p>";
		}
	else
		{
		document.getElementById('errorMessage12').innerHTML="<p>Id should contains only numbers and length should between 5 to 15</p>";
		}
}
function validateQuantity(){
	var quantity=document.getElementById('quantity').value;
	var patt = new RegExp("[0-9]{1,4}");
	if(patt.test(quantity)&&quantity<=1000)
	{
			document.getElementById('errorMessage13').innerHTML="<p></p>";
		}
	else
		{
		document.getElementById('errorMessage13').innerHTML="<p>Id should contains only numbers and it should not be more than 1000</p>";
		}
}